...
public class Config
{
    ...
    public static ForgeConfigSpec.BooleanValue SOUL_STAINED_STEEL_CLEAVER_DISABLE;
    ...
    public static boolean SoulStainedSteelCleaverDisable;
    //-------------------------------------------------------------------------------------------------
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        SoulStainedSteelCleaverDisable = SOUL_STAINED_STEEL_CLEAVER_DISABLE.get();
        //-------------------------------------------------------------------------------------------
    }
